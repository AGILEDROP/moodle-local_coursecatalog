...
$string['deletedsuccess'] = 'Category page deleted successfully.';
...
$string['enable_desc'] = 'Turn the category-page generator on or off';
...
$string['generate'] = 'Generate/Regenerate page';
$string['generatedsuccess'] = 'Page generated successfully.';
$string['lastgenerated'] = 'Last updated on {$a}';
$string['level'] = 'Level: ';
$string['managecategories'] = 'Manage category pages';
$string['managepages'] = 'Manage category pages';
...
$string['pluginname'] = 'Course category page';
$string['previewdisablednotice']   = '*** Preview mode *** This page is currently disabled.';
$string['privacy:metadata'] = 'The Course category pages plugin does not store any personal data.';
$string['savechanges']      = 'Save changes';
$string['settings']   = 'Category-page settings';
